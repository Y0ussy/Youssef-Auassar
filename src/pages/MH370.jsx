					...
					<div className="relative bg-gradient-to-b from-white to-gray-400 overflow-hidden">
						...
						<div className="flex items-center justify-center p-8 lg:p-16">
							<iframe
								...
								allowFullScreen
								className="w-full max-w-4xl h-80 md:h-96 lg:h-[500px]"
							></iframe>
						</div>
					</div>
				</div>
				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					<div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
						...
						<div className="lg:col-span-2 text-left">
							<h2 className="text-4xl md:text-5xl text-black mb-8 text-left">
								<span
									style={{
							...
							<p className="text-lg md:text-xl text-gray-700 mb-6 leading-relaxed text-left">
